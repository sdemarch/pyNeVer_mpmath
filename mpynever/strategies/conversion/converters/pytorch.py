import mpynever.strategies.conversion.converters.pytorch_layers as pyt_l
from mpynever.strategies.conversion.representation import ConversionStrategy, PyTorchNetwork
import torch
