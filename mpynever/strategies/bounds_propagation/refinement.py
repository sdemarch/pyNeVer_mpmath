...
from mpynever.strategies.verification.ssbp.constants import RefinementTarget, NeuronSplit, BoundsDirection
    ...
    def refine_input_dimension(input_bounds: HyperRectangleBounds, coef: Tensor, shift: Tensor,
        ...
        if c > 0:
            ...
            if new_upper_i < input_bounds.get_lower()[i]:
                ...
                # from mpynever.strategies.verification.ssbp.intersection import compute_input_new_max
            ...
            if new_lower_i > input_bounds.get_upper()[i]:
                ...
                # from mpynever.strategies.verification.ssbp.intersection import compute_input_new_min
